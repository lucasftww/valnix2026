      ...
      {location.pathname === "/" && isVisible && (
        <div className="fixed right-6 bottom-[190px] md:bottom-[210px] z-40 flex flex-col gap-3">
          ...
          <button
            ...
            className="absolute -top-3 -right-3 h-8 w-8 rounded-full bg-muted/80 hover:bg-muted flex items-center justify-center z-10 opacity-0 hover:opacity-100 transition-opacity"
