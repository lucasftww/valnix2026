    ...
    <div className="relative flex-1 max-w-xl">
      <div className="relative">
        <Input
          ...
          autoComplete="off"
          className="w-full pl-4 pr-12 h-12 md:h-10 bg-muted/50 border border-border/20 rounded-full text-sm text-foreground placeholder:text-muted-foreground/60 focus:ring-1 focus:ring-primary/50 focus:border-primary/30 focus:bg-muted/70 transition-colors"
          ...
          <div className="absolute top-full left-0 right-0 mt-2 bg-background border border-border rounded-xl shadow-2xl z-50 overflow-hidden" id="search-results" role="listbox" aria-label="Resultados da busca">
            {results.map((product, index) => (
              <button
                ...
                className={`w-full flex items-center gap-3 p-3 min-h-[48px] hover:bg-secondary/80 active:scale-[0.99] transition-colors text-left ${
