    ...
    <div className="hidden lg:block w-full lg:w-[340px] space-y-5">
      ...
      <div className="bg-secondary/50 rounded-2xl border border-border/10 p-5 shadow-lg shadow-black/5">
        ...
        <Button 
          ...
          className="w-full h-14 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl text-base hidden lg:flex transition-all duration-200 animate-pulse"
        >
          {loading ? (
