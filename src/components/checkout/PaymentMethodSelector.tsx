  ...
  return (
    <div className="bg-secondary/50 rounded-2xl border border-border/10 p-4 sm:p-6 lg:p-4 mx-auto w-full max-w-lg lg:max-w-none shadow-lg shadow-black/5">
      ...
      <button
        ...
        className="flex items-center gap-3 lg:gap-2.5 w-full p-3 lg:p-2.5 mt-2 lg:mt-1.5 rounded-xl border border-border/10 bg-background hover:border-border/20 transition-all text-left"
      >
