...
import { useProductById, useProductReviews, generateConsistentSalesAndReviews } from "@/hooks/data/useProducts";
    ...
    <div className="min-h-[100dvh] bg-background flex flex-col pb-[88px] lg:pb-0">
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden z-40 bg-background/95 backdrop-blur-md border-t border-border/10">
        <div className="px-4 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] flex items-center justify-between gap-3">
          ...
          <Button 
            onClick={handleBuyNow} 
            className="h-12 px-7 text-[15px] font-bold bg-success hover:bg-success/90 text-success-foreground rounded-xl active:scale-[0.97] transition-transform duration-150 shrink-0"
          >
            Comprar Agora
          </Button>
        </div>
