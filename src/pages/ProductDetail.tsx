                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="pt-4 border-t border-border/50 flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-muted-foreground"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
